        ...
        <div className="fixed inset-0 z-50 md:hidden flex">
          ...
          <aside className="absolute inset-y-0 left-0 w-80 bg-zinc-900 text-zinc-100 flex flex-col shadow-2xl border-r border-zinc-800 z-10">
            ...
            <nav className="flex-1 px-4 space-y-1.5 overflow-y-auto pt-6">
              ...
              <Link href="/food-log" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 text-zinc-400 text-sm"><Utensils className="w-4 h-4 text-emerald-500" /><span>Jurnal Makanan</span></Link>
              <Link href="/workout-log" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 px-3 py-2.5 bg-zinc-800 text-white font-medium text-sm rounded-xl"><Dumbbell className="w-4 h-4 text-emerald-500" /><span>Jurnal Olahraga</span></Link>
